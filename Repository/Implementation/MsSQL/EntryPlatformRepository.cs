...
namespace Repository.MsSQL
{
    public class EntryPlatformRepository : MsSQLContext, IEntryPlatformRepository
    {
        ...
        public List<EntryPlatformModel> SelectListByEntryId(int id)
        {
            var storedProc = "sp_selectlist_entry_platform_by_entry_id";
            return SelectList<EntryPlatformModel>(storedProc, new { id });
        }
